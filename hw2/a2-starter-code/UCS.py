...
#         and if it is already on CLOSED, delete the new instance.
    for op in Problem.OPERATORS:
      if op.precond(S):
        ...
        temp = P + S.edge_distance(new_state) # Note how to call edge_distance
        ...
        # If the new state is in CLOSED, do nothing, that is,
        # delete the new instance as instructed here. Hint from Ed: this case
